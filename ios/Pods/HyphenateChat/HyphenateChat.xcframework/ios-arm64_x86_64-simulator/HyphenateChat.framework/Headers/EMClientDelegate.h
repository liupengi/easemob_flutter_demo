 ...
 *  @param info 登录设备的设备名称及其扩展信息``EMLoginInfo``。
 *
 *  \~english
 *  Occurs when the current user account is logged in to another device.

 *  @param info The device name and extended information of the login device ``EMLoginInfo``.
 */
